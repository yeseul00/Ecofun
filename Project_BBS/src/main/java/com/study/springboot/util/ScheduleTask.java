...
public class ScheduleTask {
	...
	/**
	 * 서버 시작시 10(initialDelay)초 후 부터 20초(fixedDelay) 간격으로 호출
	 * fixedDelay = 이전 작업이 종료된 후 20,000 밀리세컨드 후 호출 (반복 호출, update 테스트 용도)
	 * fixedRate = 이전 작업이 종료되지 않아도 시작
	 */
